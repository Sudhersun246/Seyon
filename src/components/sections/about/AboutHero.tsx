  ...
  return (
    <section className="relative w-full min-h-212 flex items-center justify-center overflow-hidden -mt-25.5 mb-25">
      ...
      >
        ...
        <Link
          to="/projects"
          className={`inline-flex items-center gap-[10px] bg-[#DF440E] rounded-[10px] px-[30px] py-[14px] hover:bg-[#c53a0c] transition-colors duration-200 scroll-fade-up ${isVisible ? "visible" : ""}`}
